const sessionName = "Open Ai Bot Whatsapp";
const donet = "https://saweria.co/sansekai";
const owner = ["62889899230140"]; // Put your number here ex: ["62xxxxxxxxx"]
const {
...
async function startHisoka() {
  ...
  const client = sansekaiConnect({
    ...
    browser: ["Open Ai Bot Beltok Project", "Safari", "5.1.7"],
    auth: state,
  });
